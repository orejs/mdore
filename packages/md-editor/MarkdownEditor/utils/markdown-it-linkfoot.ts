function renderFootnoteAnchorName(tokens: any, idx: any, _: any, env: any) {
...
function renderFootnoteCaption(tokens: any, idx: any) {
...
function renderFootnoteWord(tokens: any, idx: any) {
...
function linkFoot(state: any, silent: any) {
  let attrs,
    code,
    label,
    pos,
